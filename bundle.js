...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return IndexApi; });
...
class IndexApi {
          ...
          return {
            ...
            offers: item.offers.map((offer) => {
              return Object.assign({}, offer, {
                id: Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["formatOfferTitleToId"])(offer.title),
                required: false
              });
            })
          };
  ...
  createPoint(point) {
    return this._load({
      url: `points`,
      method: _const__WEBPACK_IMPORTED_MODULE_2__["Method"].POST,
  ...
  updatePoint(id, point) {
    return this._load({
      url: `points/${id}`,
      method: _const__WEBPACK_IMPORTED_MODULE_2__["Method"].PUT,
      body: JSON.stringify(point.toRAW()),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then((response) => response.json())
  ...
  deletePoint(id) {
    return this._load({url: `points/${id}`, method: _const__WEBPACK_IMPORTED_MODULE_2__["Method"].DELETE});
  }
  ...
  _load({url, method = _const__WEBPACK_IMPORTED_MODULE_2__["Method"].GET, body = null, headers = new Headers()}) {
...
class Provider {
  ...
  createPoint(point) {
    ...
    const localNewPointId = Object(nanoid__WEBPACK_IMPORTED_MODULE_1__["nanoid"])();
    const localNewPoint = _models_point__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(point, {id: localNewPointId}));
  ...
  updatePoint(id, point) {
    ...
    const localPoint = _models_point__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(point, {id}));
...
const getFilterNameById = (id) => {
  return id.substring(_const__WEBPACK_IMPORTED_MODULE_1__["FILTER_ID_PREFIX"].length);
};
...
const createNewEventTemplate = (newEvent, options = {}) => {
  ...
  const price = Object(he__WEBPACK_IMPORTED_MODULE_4__["encode"])(notSanitizedPrice.toString());
  const currentCity = Object(he__WEBPACK_IMPORTED_MODULE_4__["encode"])(notSanitizedCurrentCity);
  ...
  const renderEventTypesGroupMarkup = (start, end) => {
    return _const__WEBPACK_IMPORTED_MODULE_1__["EVENT_TYPES"].slice(start, end).map((eventType) => {
      return getTypesMarkup(eventType, eventType === Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatString"])(type));
    }).join(`\n`);
  };
  ...
  const checkEventMode = () => {
    return mode !== _const__WEBPACK_IMPORTED_MODULE_1__["Mode"].ADDING ? (
            ...
            <header class="event__header">
              <div class="event__type-wrapper">
                ...
                <div class="event__type-list">
                  <fieldset class="event__type-group">
                    ...
                    ${renderEventTypesGroupMarkup(0, _const__WEBPACK_IMPORTED_MODULE_1__["TRANSFER_EVENTS"])}
                  </fieldset>

                  <fieldset class="event__type-group">
                    <legend class="visually-hidden">Activity</legend>
                    ${renderEventTypesGroupMarkup(_const__WEBPACK_IMPORTED_MODULE_1__["TRANSFER_EVENTS"], _const__WEBPACK_IMPORTED_MODULE_1__["ACTIVITY_EVENTS"])}
                  </fieldset>
                </div>
              </div>
              ...
              <div class="event__field-group  event__field-group--destination">
                <label class="event__label  event__type-output" for="event-destination-1">
                  ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatString"])(type)} ${_const__WEBPACK_IMPORTED_MODULE_1__["EventSuffix"][Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["checkSuffix"])(type)]}
                </label>
              ...
              <div class="event__field-group  event__field-group--time">
                ...
                <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(eventStartTime)} ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(eventStartTime)}">
                &mdash;
                <label class="visually-hidden" for="event-end-time-1">
                  To
                </label>
                <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(eventEndTime)} ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(eventEndTime)}">
              </div>
...
class NewEvent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(event, mode, pointsModel) {
    ...
    this._externalData = _const__WEBPACK_IMPORTED_MODULE_1__["DefaultData"];
  ...
  setData(data) {
    this._externalData = Object.assign({}, _const__WEBPACK_IMPORTED_MODULE_1__["DefaultData"], data);
    this.rerender();
  }
  ...
  setFavoriteBtnHandler(handler) {
    if (this._mode === _const__WEBPACK_IMPORTED_MODULE_1__["Mode"].ADDING) {
      return;
    }
  ...
  setFlatpickr(dateElement, eventDate) {
    if (dateElement.id.match(/(start)/g)) {
      this._flatpickrStartTime = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(dateElement, this._makeFlatpickrElement(eventDate));
    } else {
      this._flatpickrEndTime = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(dateElement, this._makeFlatpickrElement(eventDate));
    }
  ...
  _subscribeOnEvents() {
    ...
    startTime.addEventListener(`change`, (evt) => {
      this._eventStartDate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatDateToDefault"])(evt.target.value);
    });

    endTime.addEventListener(`change`, (evt) => {
      this._eventEndDate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatDateToDefault"])(evt.target.value);
    });
    ...
    eventTypeList.addEventListener(`change`, (evt) => {
      ...
      this._eventOffers = this._offersByType.get(evt.target.value).map((offer) => {
        return Object.assign({}, offer, {
          id: Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatOfferTitleToId"])(offer.title),
          required: false
        });
      });
      this.rerender();
...
/***/ "./src/components/no-trip-days.js":
/*!****************************************!*\
  !*** ./src/components/no-trip-days.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoTripDays; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class NoTripDays extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createSortTemplate = (sortType, isDisabled = false) => {
  return (
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      ${sortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT ? `<span class="trip-sort__item  trip-sort__item--day">Day</span>` : `<span class="trip-sort__item  trip-sort__item--day"></span>`}

      <div class="trip-sort__item  trip-sort__item--event">
        <input id="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT}" ${sortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT ? `checked` : ``} ${isDisabled ? `disabled` : ``}>
        <label class="trip-sort__btn" for="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT}">Event</label>
      </div>

      <div class="trip-sort__item  trip-sort__item--time">
        <input id="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}" ${sortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME ? `checked` : ``} ${isDisabled ? `disabled` : ``}>
        <label class="trip-sort__btn" for="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}">
          Time
      ...
      <div class="trip-sort__item  trip-sort__item--price">
        <input id="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}" ${sortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE ? `checked` : ``} ${isDisabled ? `disabled` : ``}>
        <label class="trip-sort__btn" for="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}">
          Price
          <svg class="trip-sort__direction-icon" width="8" height="10" viewBox="0 0 8 10">
            <path d="M2.888 4.852V9.694H5.588V4.852L7.91 5.068L4.238 0.00999987L0.548 5.068L2.888 4.852Z"/>
          </svg>
...
class Sort extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._currenSortType = _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT;
...
const calcUniqItemsTimeSpent = (points, type) => {
  ...
  const pointsTimeSpent = points.reduce((acc, point) => {
    if (point.type.toUpperCase() === type) {
      const durationTime = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["getDurationDate"])(point.time.eventStartTime, point.time.eventEndTime);
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(moneyCtx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        anchor: `start`,
        minBarLength: _const__WEBPACK_IMPORTED_MODULE_4__["MIN_BAR_LENGTH"],
        barThickness: _const__WEBPACK_IMPORTED_MODULE_4__["BAR_THICKNESS"]
      }]
    },
    options: {
      plugins: {
        datalabels: {
          font: {
            size: _const__WEBPACK_IMPORTED_MODULE_4__["DATALABELS_SIZE"]
          },
          color: `#000000`,
          anchor: `end`,
          align: `start`,
      ...
      title: {
        ...
        text: `MONEY`,
        fontColor: `#000000`,
        fontSize: _const__WEBPACK_IMPORTED_MODULE_4__["TITLE_FONT_SIZE"],
        position: `left`
      },
      scales: {
        yAxes: [{
          ticks: {
            fontColor: `#000000`,
            padding: _const__WEBPACK_IMPORTED_MODULE_4__["TICKS_PADDING"],
            fontSize: _const__WEBPACK_IMPORTED_MODULE_4__["TICKS_FONT_SIZE"],
            callback: (type) => {
              return `${_const__WEBPACK_IMPORTED_MODULE_4__["iconMap"][type.toLowerCase()]} ${type.toUpperCase()}`;
            }
          },
          gridLines: {
            display: false,
...
const renderTimeSpentChart = (timeSpentCtx, points) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(timeSpentCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
    type: `horizontalBar`,
    data: {
      labels: pointTypes,
...
class Statistics extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _renderCharts() {
    ...
    moneyCtx.height = _const__WEBPACK_IMPORTED_MODULE_4__["BAR_HEIGHT"] * _const__WEBPACK_IMPORTED_MODULE_4__["MONEY_TIME_SPENT_CHART_FACTOR"];
    transportCtx.height = _const__WEBPACK_IMPORTED_MODULE_4__["BAR_HEIGHT"] * _const__WEBPACK_IMPORTED_MODULE_4__["TRANSPORT_CHART_FACTOR"];
    timeSpentCtx.height = _const__WEBPACK_IMPORTED_MODULE_4__["BAR_HEIGHT"] * _const__WEBPACK_IMPORTED_MODULE_4__["MONEY_TIME_SPENT_CHART_FACTOR"];
...
const createTripDaysTemplate = (day, index, sortType = _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT) => {
  ...
  const getDayInfo = (currentSortType) => {
    return currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT ? (
...
class TripDays extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  renderEventsList(events) {
    events.forEach((event) => {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this.getElement().querySelector(`.trip-events__list`), event);
    });
  }
}
...
const createEventMarkup = (tripEvent) => {
  ...
  const getSelectedOffers = () => {
    return offers ? offers.slice(0, _const__WEBPACK_IMPORTED_MODULE_0__["MAX_SHOWING_OFFERS"]).map((offer) => {
  ...
  const getDurationTime = () => {
    const duration = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getDurationDate"])(eventStartTime, eventEndTime);
  ...
  const eventTimeMarkup = () => {
    const startISOString = eventStartTime.toISOString().slice(0, _const__WEBPACK_IMPORTED_MODULE_0__["MAX_ISO_STRING_LENGTH"]);
    const endISOString = eventEndTime.toISOString().slice(0, _const__WEBPACK_IMPORTED_MODULE_0__["MAX_ISO_STRING_LENGTH"]);

    return (
      `<p class="event__time">
        <time class="event__start-time" datetime="${startISOString}">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(eventStartTime)}</time>
        &mdash;
        <time class="event__end-time" datetime="${endISOString}">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(eventEndTime)}</time>
      </p>
  ...
  return (
    `<div class="event">
      ...
      <h3 class="event__title">${type} ${_const__WEBPACK_IMPORTED_MODULE_0__["EventSuffix"][Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["checkSuffix"])(type)]} ${destination.currentCity}</h3>
...
class TripEvents extends _abstract_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(event) {
    super();
...
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
/* harmony import */ var _utils_trip_info__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/trip-info */ "./src/utils/trip-info.js");



const createTripInfoTemplate = (points) => {
  const route = (points.length > 0) ? Object(_utils_trip_info__WEBPACK_IMPORTED_MODULE_1__["getRoute"])(points) : ``;
  const dates = (points.length > 0) ? Object(_utils_trip_info__WEBPACK_IMPORTED_MODULE_1__["getRouteDates"])(points) : ``;
  const cost = (points.length > 0) ? Object(_utils_trip_info__WEBPACK_IMPORTED_MODULE_1__["getFullCost"])(points) : ``;
...
class TripList extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventSuffix", function() { return EventSuffix; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAX_ISO_STRING_LENGTH", function() { return MAX_ISO_STRING_LENGTH; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAX_SHOWING_OFFERS", function() { return MAX_SHOWING_OFFERS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FIRST_DAY_COUNTER", function() { return FIRST_DAY_COUNTER; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MIN_BAR_LENGTH", function() { return MIN_BAR_LENGTH; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BAR_THICKNESS", function() { return BAR_THICKNESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DATALABELS_SIZE", function() { return DATALABELS_SIZE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TITLE_FONT_SIZE", function() { return TITLE_FONT_SIZE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TICKS_PADDING", function() { return TICKS_PADDING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TICKS_FONT_SIZE", function() { return TICKS_FONT_SIZE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MONEY_TIME_SPENT_CHART_FACTOR", function() { return MONEY_TIME_SPENT_CHART_FACTOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRANSPORT_CHART_FACTOR", function() { return TRANSPORT_CHART_FACTOR; });
...
class FilterController {
  ...
  setDefaultView(menuItem = _const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE) {
    this._pointsModel.setFilter(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING);
    this._activeFilterType = _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING;
    this.render();
    return menuItem === _const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATISTICS ? this._filterComponent.setDisableInputs() : this._filterComponent.removeDisableInputs();
  }
...
/* harmony import */ var _components_trip_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/trip-events */ "./src/components/trip-events.js");
/* harmony import */ var _components_new_event__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/new-event */ "./src/components/new-event.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/common */ "./src/utils/common.js");
/* harmony import */ var _models_point__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/point */ "./src/models/point.js");
...
const parseFormData = (formData, destinations, offersByType, eventData) => {
  const choosenType = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatString"])(formData.get(`event-type`));
  ...
  const currentEventDestination = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["parseDestinationInfo"])(destinations, formData.get(`event-destination`));

  return new _models_point__WEBPACK_IMPORTED_MODULE_4__["default"]({
    "id": eventData.id,
    "type": choosenType,
    "destination": {
    ...
    "date_from": Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatDateToDefault"])(formData.get(`event-start-time`)),
    "date_to": Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatDateToDefault"])(formData.get(`event-end-time`)),
...
class PointController {
  constructor(onDataChange, onViewChange, pointsModel) {
    ...
    this._offersByType = this._pointsModel.getOffersByType();
    this._destinations = this._pointsModel.getDestinations();
    this._mode = _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT;
  ...
  render(event, mode, newEventBtn) {
    ...
    this._currentEvent = new _components_trip_events__WEBPACK_IMPORTED_MODULE_0__["default"](event);
    this._eventEditComponent = new _components_new_event__WEBPACK_IMPORTED_MODULE_1__["default"](event, this._mode, this._pointsModel);
    ...
    this._eventEditComponent.setCloseButtonClickHandler(() => {
      if (this._mode === _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING) {
    ...
    this._eventEditComponent.setFavoriteBtnHandler(() => {
      ...
      const newPoint = _models_point__WEBPACK_IMPORTED_MODULE_4__["default"].clone(event);
    ...
    this._eventEditComponent.setSubmitHandler((evt) => {
      ...
      return mode === _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING ? this._onDataChange(this, event, data, false, this._button) : this._onDataChange(this, event, data);
    });
    ...
    this._eventEditComponent.setDeleteButtonClickHandler(() => {
      ...
      this._eventEditComponent.setDisable();
      this._eventEditComponent.removeRedBorder();
      return mode === _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING ? this._onDataChange(this, event, null, false, this._button) : this._onDataChange(this, event, null);
    });

    if (mode === _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT) {
      if (oldEventEditComponent && oldEventComponent) {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._currentEvent, oldEventComponent);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventEditComponent, oldEventEditComponent);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldEventComponent);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldEventEditComponent);
        this._replaceEditToEvent();
      }
      return this._currentEvent;
    } else if (mode === _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING) {
      if (oldEventEditComponent && oldEventComponent) {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldEventComponent);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldEventEditComponent);
      }
  ...
  setDefaultView() {
    if (this._mode !== _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT) {
      this._replaceEditToEvent();
    }
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventEditComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._currentEvent);
    document.removeEventListener(`keydown`, this._onEscKeyDown);
  }

  shake() {
    this._eventEditComponent.getElement().style.animation = `shake ${_const__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"] / 1000}s`;
    this._currentEvent.getElement().style.animation = `shake ${_const__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"] / 1000}s`;
    ...
    }, _const__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"]);

    setTimeout(() => this._eventEditComponent.setRedBorder(), _const__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"]);
  }

  _replaceEventToEdit() {
    this._onViewChange();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventEditComponent, this._currentEvent);
    this._mode = _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].EDIT;
  }
  ...
  _replaceEditToEvent() {
    ...
    if (document.contains(this._eventEditComponent.getElement())) {
      if (this._eventEditComponent.getCurrentMode() === _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING) {
        Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["removeComponent"])(this._eventEditComponent);
        return;
      }
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._currentEvent, this._eventEditComponent);
    }
    this._mode = _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT;
  }
...
/* harmony import */ var _components_trip_days__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/trip-days */ "./src/components/trip-days.js");
/* harmony import */ var _components_no_trip_days__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/no-trip-days */ "./src/components/no-trip-days.js");
...
const getSortedEvents = (events, sortType) => {
  ...
  switch (sortType) {
    case _const__WEBPACK_IMPORTED_MODULE_5__["SortType"].EVENT:
      ...
      break;
    case _const__WEBPACK_IMPORTED_MODULE_5__["SortType"].TIME:
      ...
      break;
    case _const__WEBPACK_IMPORTED_MODULE_5__["SortType"].PRICE:
...
class TripController {
  constructor(container, filterController, pointsModel, api) {
    ...
    this._tripList = new _components_trip_list__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._sort = new _components_sort__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._noTripDays = new _components_no_trip_days__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  hide() {
    this._container.classList.add(_const__WEBPACK_IMPORTED_MODULE_5__["HIDDEN_CLASS"]);
    this._updatePoints();
  }

  show() {
    this._container.classList.remove(_const__WEBPACK_IMPORTED_MODULE_5__["HIDDEN_CLASS"]);
    this._updatePoints();
  }
  ...
  createPoint(button) {
    ...
    this._creatingPoint = new _point_controller__WEBPACK_IMPORTED_MODULE_6__["default"](this._onDataChange, this._onViewChange, this._pointsModel);
    this._pointControllers.push(this._creatingPoint);
    const newEvent = this._creatingPoint.render(_point_controller__WEBPACK_IMPORTED_MODULE_6__["EmptyPoint"], _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING, button);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, newEvent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
  }
  ...
  _renderEventsList(eventsList) {
    ...
    return eventsList.map((tripEvent) => {
      const pointController = new _point_controller__WEBPACK_IMPORTED_MODULE_6__["default"](this._onDataChange, this._onViewChange, this._pointsModel);
      this._pointControllers.push(pointController);
      return pointController.render(tripEvent, _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
    });
  }

  _renderSortingByDay(currentEvents, currentContainer) {
    currentEvents.forEach((day, index) => {
      const tripDay = new _components_trip_days__WEBPACK_IMPORTED_MODULE_2__["default"](day.items, index);
      const tripEventsList = this._renderEventsList(day.items);
      tripDay.renderEventsList(tripEventsList);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(currentContainer, tripDay);
    });
  }

  _renderSortingByType(currentEvents, currentContainer, sortType) {
    const tripDay = new _components_trip_days__WEBPACK_IMPORTED_MODULE_2__["default"](currentEvents[0], _const__WEBPACK_IMPORTED_MODULE_5__["FIRST_DAY_COUNTER"], sortType);
  ...
  _onSortTypeChange(sortType, button = null) {
    ...
    if (sortType !== _const__WEBPACK_IMPORTED_MODULE_5__["SortType"].EVENT) {
    ...
    const container = this._tripList.getElement();
    this._removePoints();
    return sortType === _const__WEBPACK_IMPORTED_MODULE_5__["SortType"].EVENT ? this._renderSortingByDay(sortedEvents, container) : this._renderSortingByType(sortedEvents, container, sortType);
  }

  _updatePoints() {
    this._removePoints();
    if (this._pointsModel.getPointsAll().length <= 0) {
      Object(_utils_common__WEBPACK_IMPORTED_MODULE_7__["removeComponent"])(this._sort);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._noTripDays);
    } else {
      if (this._sort) {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripList.getElement(), this._sort, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN);
      }
      Object(_utils_common__WEBPACK_IMPORTED_MODULE_7__["removeComponent"])(this._noTripDays);
  ...
  _onDataChange(pointController, oldData, newData, isFavBtnHandler = false, newEventBtn = null) {
    if (oldData === _point_controller__WEBPACK_IMPORTED_MODULE_6__["EmptyPoint"]) {
      this._creatingPoint = null;
      if (newData === null) {
        ...
        this._api.createPoint(newData)
          .then((pointModel) => {
            ...
            pointController.render(pointModel, _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
            this._updatePoints();
            if (newEventBtn) {
              newEventBtn.removeAttribute(`disabled`);
  ...
  _onNewEventViewChange(button) {
    ...
    this._onViewChange();
    this._onSortTypeChange(_const__WEBPACK_IMPORTED_MODULE_5__["SortType"].EVENT, button);
  }
  ...
  _onFilterChange() {
    ...
    this._sort.setCurrentSortType(_const__WEBPACK_IMPORTED_MODULE_5__["SortType"].EVENT);
    this._updatePoints();
  }

  renderEvents(container, points) {
    const defaultSortedEvents = getSortedEvents(points, _const__WEBPACK_IMPORTED_MODULE_5__["SortType"].EVENT);
  ...
  renderTripList() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._tripList);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(tripListContainer, this._sort, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN);
    if (points.length < 1) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._noTripDays);
      this._sort.hide();
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _api_index_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api/index-api */ "./src/api/index-api.js");
/* harmony import */ var _api_provider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api/provider */ "./src/api/provider.js");
/* harmony import */ var _api_store_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api/store.js */ "./src/api/store.js");
/* harmony import */ var _components_trip_info__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/trip-info */ "./src/components/trip-info.js");
...
/* harmony import */ var _components_statistics__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/statistics */ "./src/components/statistics.js");
/* harmony import */ var _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controllers/filter-controller */ "./src/controllers/filter-controller.js");
...
/* harmony import */ var _models_points__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./models/points */ "./src/models/points.js");
...
/* harmony import */ var _utils_filter__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./utils/filter */ "./src/utils/filter.js");
...
const api = new _api_index_api__WEBPACK_IMPORTED_MODULE_0__["default"](_const__WEBPACK_IMPORTED_MODULE_12__["END_POINT"], _const__WEBPACK_IMPORTED_MODULE_12__["AUTHORIZATION"]);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_2__["default"](_const__WEBPACK_IMPORTED_MODULE_12__["STORE_NAME"], window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_1__["default"](api, store);
const pointsModel = new _models_points__WEBPACK_IMPORTED_MODULE_9__["default"]();
const loadingComponent = new _components_loading__WEBPACK_IMPORTED_MODULE_10__["default"]();
...
const siteMenu = new _components_menu__WEBPACK_IMPORTED_MODULE_4__["default"]();
const tripInfo = new _components_trip_info__WEBPACK_IMPORTED_MODULE_3__["default"](pointsModel);

Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(siteHeader, tripInfo, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTERBEGIN);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(siteNavigationMenuHeader, siteMenu, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTEREND);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(siteTripEvents, loadingComponent);

const filterController = new _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_6__["default"](siteNavigationMenu, pointsModel);

const tripController = new _controllers_trip_controller__WEBPACK_IMPORTED_MODULE_8__["default"](siteTripEvents, filterController, pointsModel, apiWithProvider);
apiWithProvider.getData()
  .then((points) => {
    ...
    Object(_utils_common__WEBPACK_IMPORTED_MODULE_11__["removeComponent"])(loadingComponent);
    Object.values(_const__WEBPACK_IMPORTED_MODULE_12__["FilterType"]).map((filter) => {
      const filteredPoints = Object(_utils_filter__WEBPACK_IMPORTED_MODULE_13__["getPointsByFilter"])(pointsModel.getPointsAll(), filter.toLowerCase());
...
pointsModel.setDataChangeHandler(() => {
  Object(_utils_common__WEBPACK_IMPORTED_MODULE_11__["removeComponent"])(tripInfo);
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(siteHeader, tripInfo, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTERBEGIN);
});
...
const statisticsComponent = new _components_statistics__WEBPACK_IMPORTED_MODULE_5__["default"]({points: pointsModel});
Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(siteTripEvents, statisticsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTEREND);
...
siteMenu.setOnTripTabsChange((menuItem) => {
  ...
  switch (menuItem) {
    case _const__WEBPACK_IMPORTED_MODULE_12__["MenuItem"].TABLE:
      setCurrentView(_const__WEBPACK_IMPORTED_MODULE_12__["MenuItem"].TABLE, statisticsComponent, tripController);
      newEventButton.removeAttribute(`disabled`);
      break;
    case _const__WEBPACK_IMPORTED_MODULE_12__["MenuItem"].STATISTICS:
      setCurrentView(_const__WEBPACK_IMPORTED_MODULE_12__["MenuItem"].STATISTICS, tripController, statisticsComponent);
...
class Point {
  constructor(point) {
    this.id = point[`id`];
    this.type = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatString"])(point[`type`]);
    this.time = {
  ...
  toRAW() {
    return {
      ...
      "offers": this.offers ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatOffers"])(this.offers) : null,
...
class Points {
  ...
  getPoints() {
    return Object(_utils_filter__WEBPACK_IMPORTED_MODULE_0__["getPointsByFilter"])(this._points, this._activeFilterType);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: removeComponent, formatOffers, formatOfferTitleToId, checkSuffix, formatTime, formatDate, getDurationDate, isFutureDate, isPastDate, formatDateToDefault, formatString, parseDestinationInfo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeComponent", function() { return removeComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatOffers", function() { return formatOffers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatOfferTitleToId", function() { return formatOfferTitleToId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkSuffix", function() { return checkSuffix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatTime", function() { return formatTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDate", function() { return formatDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDurationDate", function() { return getDurationDate; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateToDefault", function() { return formatDateToDefault; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatString", function() { return formatString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseDestinationInfo", function() { return parseDestinationInfo; });
...
const formatDateToDefault = (date) => {
  moment__WEBPACK_IMPORTED_MODULE_0___default.a.defaultFormat = `DD.MM.YYYY HH:mm`;
...
const getDurationDate = (startDate, endDate) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(moment__WEBPACK_IMPORTED_MODULE_0___default()(endDate).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(startDate)));
};
...
const getPointsByFilter = (points, filterType) => {
  ...
  switch (filterType) {
    ...
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FUTURE:
      return getFilteredPoints(points, nowDate, _common__WEBPACK_IMPORTED_MODULE_1__["isFutureDate"]);
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST:
      return getFilteredPoints(points, nowDate, _common__WEBPACK_IMPORTED_MODULE_1__["isPastDate"]);
  }
...
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RenderPosition", function() { return _const__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"]; });
...
const render = (container, element, place = _const__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND) => {
  switch (place) {
    ...
    case _const__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND:
      ...
      break;
    case _const__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTEREND:
      container.after(element.getElement());
      break;
    case _const__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN:
...
/***/ "./src/utils/trip-info.js":
/*!********************************!*\
  !*** ./src/utils/trip-info.js ***!
  \********************************/
/*! exports provided: getFullCost, getRoute, getRouteDates */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return offers.length > 0 ? offers
    .map((offer) => {
      return {
        ...
        price: parseInt(offer.price, _const__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_RADIX"])
      };
    })
    .map((offer) => {
      if (offer.required) {
...
const getRoute = (points) => {
  ...
  if (route.length <= _const__WEBPACK_IMPORTED_MODULE_0__["MAX_SHOWING_OFFERS"]) {
    route = route
      .map((city) => `${city}`)
      .join(` — `);
  } else {
...
const getRouteDates = (points) => {
  ...
  const getDateStartString = () => {
    return `${_const__WEBPACK_IMPORTED_MODULE_0__["monthMap"].get(dates[0].getMonth())} ${dates[0].getDate()}`;
  };

  const getDateFinishString = () => {
    return _const__WEBPACK_IMPORTED_MODULE_0__["monthMap"].get(dates[0].getMonth()) === _const__WEBPACK_IMPORTED_MODULE_0__["monthMap"].get(dates[1].getMonth()) ?
      `${dates[1].getDate()}` :
      `${_const__WEBPACK_IMPORTED_MODULE_0__["monthMap"].get(dates[1].getMonth())} ${dates[1].getDate()}`;
  };
